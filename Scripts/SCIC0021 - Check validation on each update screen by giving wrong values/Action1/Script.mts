...
Dim dt_TCID, dt_ScenarioName, dt_TestCase, dt_ExpectedResult,ChageField


Call spLoadLibrary()
Call spInitiateData("Excel_Report.xlsx", "SCIC0021 - Check validation on each update screen by giving wrong values.xlsm", "sheetname")
Call spGetDatatable()
...
Select Case DataTable.Value("SCREEN_DETAIL",dtlocalsheet)
	Case 67010
		Call Change_Field_67010
	Case 67103
		Call Change_Field_67103
	Case 67109
		Call Change_Field_67109
End Select

Call Check_Status_Notif()
Call GoTo_ScreenNumber()
Call Search_Detail_CIF_67050()
...
Sub spLoadLibrary()
	...
	Call RepositoriesCollection.Add(LibRepo & "RP_Screen_67100.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Screen_67010.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Screen_67109.tsr")
	Call RepositoriesCollection.Add(LibRepo & "RP_Screen_67103.tsr")
End Sub
